...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 24. Mai 2015 um 07:08
...
INSERT INTO `cities` (`id`, `region_id`, `name`, `timezone`) VALUES
...
(3001, 704, 'Hà Nội', 'Asia/Ho_Chi_Minh'),
...
(3012, 704, 'Nam Hà', 'Asia/Ho_Chi_Minh'),
...
--
-- Tabellenstruktur für Tabelle `comment_like`
--
...
--
-- Tabellenstruktur für Tabelle `currency_converters`
--

CREATE TABLE IF NOT EXISTS `currency_converters` (
...
--
-- Daten für Tabelle `currency_converters`
--

INSERT INTO `currency_converters` (`id`, `from`, `to`, `rates`, `created`, `modified`) VALUES
(1, 'VND', 'USD', '0.0000', '2015-05-03 06:00:31', '2015-05-03 06:00:31'),
(2, 'GBP', 'EUR', '1.3516', '2015-05-03 06:02:31', '2015-05-03 06:02:31'),
(3, 'USD', 'EUR', '0.8928', '2015-05-03 06:03:11', '2015-05-03 06:03:11'),
(4, 'VND', 'EUR', '0.0000', '2015-05-03 06:03:30', '2015-05-03 06:03:30'),
(5, 'VND', 'USD', '0.0000', '0000-00-00 00:00:00', '2015-05-03 06:03:44'),
(6, 'VN', 'USD', 'N/A', '2015-05-03 06:03:59', '2015-05-03 06:03:59'),
(7, 'VND', 'USD', '0.0000', '0000-00-00 00:00:00', '2015-05-03 06:06:00'),
(8, 'VND', 'USD', '0.0000', '0000-00-00 00:00:00', '2015-05-03 06:06:01'),
(9, 'VUV', 'USD', '0.0093', '2015-05-03 06:06:12', '2015-05-03 06:06:12'),
(10, 'EUR', 'USD', '1.1200', '2015-05-03 06:06:51', '2015-05-03 06:06:51'),
(11, 'USD', 'VND', '21590.0000', '2015-05-03 06:07:13', '2015-05-03 06:07:13');
...
`id` int(11) NOT NULL,
  `type` enum('0','1') NOT NULL DEFAULT '0' COMMENT '0:normal , 1: admin',
...
INSERT INTO `users` (`id`, `type`, `status`, `email`, `password`, `full_name`, `image`, `birthday`, `phone`, `address`, `city_id`, `ip_address`, `created`, `modified`) VALUES
(1, '1', 1, 'admin@traodoionline.com', '$2y$10$GhDmjMRQHmaqsZmluc140OzxkopV0K0OtAgbK6OyDOvRuvOkupNRK', 'Dung Nguyen', 'avatar', '2015-04-28', 942020041, '40/25 Le Thi Hong', 1, NULL, '2015-04-28 03:03:09', '2015-04-30 06:18:06');
...
--
ALTER TABLE `cities`
 ADD PRIMARY KEY (`id`), ADD KEY `subregion_region_id` (`region_id`);
...
--
-- Indizes für die Tabelle `comment_like`
--
ALTER TABLE `comment_like`
 ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `currency_converters`
--
ALTER TABLE `currency_converters`
 ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT für Tabelle `comment_like`
--
ALTER TABLE `comment_like`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `currency_converters`
--
ALTER TABLE `currency_converters`
