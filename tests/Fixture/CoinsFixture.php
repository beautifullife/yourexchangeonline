...
class CoinsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'accept_methods' => ['type' => 'string', 'length' => 256, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'accept_methods' => 'Lorem ipsum dolor sit amet',
            'status' => 1,
            'created' => '2015-07-24 10:57:20',
            'modified' => '2015-07-24 10:57:20'
        ],
    ];
}
