...
class NewslettersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sent_count' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'sent_count' => '',
            'created' => '2015-08-04 09:45:26',
            'modified' => '2015-08-04 09:45:26'
        ],
    ];
}
