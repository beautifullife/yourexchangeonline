...
<div class="col-md-3 col-sm-6 col-xs-12">
  <div class="info-box bg-blue">
    ...
    <div class="info-box-content">
      ...
      <?= $this->Html->link('More info '.$this->Html->tag('i','',[
                                        'class' => 'fa fa-arrow-circle-right',
                                        ]),[
        'controller'    => 'Posts',
        'action'        => 'index'                                
        ],[
        'class'     => 'small-box-footer bg-primary',
        'escape'    => false,
      ]) ?>
...
<div class="col-md-3 col-sm-6 col-xs-12">
  <div class="info-box">
    ...
    <div class="info-box-content">
      <span class="info-box-text"><?= __('Exchanged Products') ?></span>
    ...
    <div class="box-body">
      ...
      <div class="direct-chat-messages">
        ...
        <div class="direct-chat-msg">
          ...
          <?= $this->Html->image('demo/user1-128x128.jpg',[
      ...
      <div class="direct-chat-contacts">
        <ul class='contacts-list'>
          ...
          <li>
            <a href='#'>
              <?= $this->Html->image('demo/user3-128x128.jpg',[
                                'alt'   => __('message user image'),
                                'class' => 'contacts-list-img',
                            ]) ?>
              <div class='contacts-list-info'>
